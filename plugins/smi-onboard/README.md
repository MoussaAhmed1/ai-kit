...
Works with all Smicolon framework plugins. When the project uses `smi-django`, `smi-nextjs`, or others, the onboarding automatically includes framework-specific conventions.
